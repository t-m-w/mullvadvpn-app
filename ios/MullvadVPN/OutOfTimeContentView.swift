...
class OutOfTimeContentView: UIView {
    ...
    lazy private var failImageView: UIImageView = {
...
private extension OutOfTimeContentView {
    ...
    func configureConstraints() {
        NSLayoutConstraint.activate([
            ...
            topStackView.leadingAnchor.constraint(equalTo: layoutMarginsGuide.leadingAnchor, constant: 16),
            topStackView.trailingAnchor.constraint(equalTo: layoutMarginsGuide.trailingAnchor, constant: -16),
            ...
            bottomStackView.leadingAnchor.constraint(equalTo: layoutMarginsGuide.leadingAnchor, constant: 16),
            bottomStackView.trailingAnchor.constraint(equalTo: layoutMarginsGuide.trailingAnchor, constant: -16),
            bottomStackView.bottomAnchor.constraint(equalTo: layoutMarginsGuide.bottomAnchor, constant: -16),
        ])
    }
